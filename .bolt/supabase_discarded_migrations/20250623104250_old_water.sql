/*
  ...
  1. Demo Users
    ...
    - Manager user with management access
    - Staff user with standard access
  ...
  3. Sample Vehicles
    ...
    - Various battery types and conditions

  4. Sample Check-in/out Records
    - Different statuses and types
    - Associated service items
    - Sample photos and documentation
*/
